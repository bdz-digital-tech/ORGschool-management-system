...
const apiRequest = async (endpoint, options = {}) => {
  ...
  try {
    ...
    // Se não autorizado, limpar token (mas não no próprio login, que dá 401 quando a senha está errada)
...
export const alunosAPI = {
  ...
  listar: async (params = {}) => {
    const query = new URLSearchParams({ limite: 500, ...params }).toString();
  ...
  alterarEstado: async (id, estado) => {
    return apiRequest(`/alunos/${id}/estado`, {
      method: 'PATCH',
...
export const professoresAPI = {
  listar: async (params = {}) => {
    const query = new URLSearchParams({ limite: 500, ...params }).toString();
    return apiRequest(`/professores?${query}`);
  },
...
export const matriculasAPI = {
  listar: async (params = {}) => {
    const query = new URLSearchParams({ limite: 500, ...params }).toString();
    return apiRequest(`/matriculas?${query}`);
  },
...
export const pagamentosAPI = {
  listar: async (params = {}) => {
    const query = new URLSearchParams({ limite: 500, ...params }).toString();
    return apiRequest(`/pagamentos?${query}`);
  },
...
// ============================================================
// API: CLASSES (com turmas aninhadas)
// ============================================================
